			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a href="<?php echo site_url('member/mgaleri/') ?>"><i class="fas fa-arrow-left"></i>
							Back</a>
					</div>
					<div class="card-body">

						<form action="<?php base_url("member/mgaleri/edit") ?>" method="post"
							enctype="multipart/form-data" >

							<input type="hidden" name="id_galeri" value="<?php echo $mgaleri->id_galeri?>" />

							<div class="form-group">
								<label for="name">Name*</label>
								<input class="form-control <?php echo form_error('nama_gal') ? 'is-invalid':'' ?>"
								 type="text" name="nama_gal" placeholder="Nama galeri" value="<?php echo $mgaleri->nama_gal ?>" />
							...
							<div class="form-group">
								...
								<input type="hidden" name="old_image" value="<?php echo $mgaleri->image ?>" />
								<div class="invalid-feedback">
									<?php echo form_error('image') ?>
								</div>
							</div>

							<input type="hidden" name="id_usaha" value="<?php echo $mgaleri->id_usaha?>" />
